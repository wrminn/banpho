...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('texteditor', function (Blueprint $table) {
            ...
            $table->dateTime('texteditor_date_update')->nullable(); // วันที่อัปเดต
            $table->string('texteditor_menu')->nullable(); // เป็นข้อมูลของเมนูไหน
            $table->unsignedBigInteger('texteditor_user_id_insert')->nullable(); // user ที่ insert
            $table->unsignedBigInteger('texteditor_user_id_update')->nullable(); // user ที่ update
        ...
        Schema::create('texteditor_detail', function (Blueprint $table) {
            ...
            $table->string('texteditor_detail');
