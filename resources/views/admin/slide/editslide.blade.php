    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="" action="{{ route('editbannerone', ['menu' => $menuId, 'id' => $id]) }}" method="post"
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="slot" class="form-label">รูปหัวข้อ
                                    @if (!empty($list->banner_topic_picture))
                                        <img src="{{ asset('storage/' . $list->banner_topic_picture) }}" width="10%">
                                    @endif
                                </label>
