                ...
                <caption>
                    <div class="row">
                        ...
                        <div class="col-md-1 ms-auto">
                            <a href="/backend/addslide/menu/{{ $menuId }}"><button type="button"
                    ...
                    @else
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td>
                                    @if (!empty($item->slide_topic_picture))
                                        <img src="{{ asset('storage/' . $item->slide_topic_picture) }}" width="30%">
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('editslideone', ['menu' => $menuId, 'id' => $item->slide_id]) }}">
                                    ...
                                    <a href="{{ route('deleteslideone', ['menu' => $menuId, 'id' => $item->slide_id]) }}">
