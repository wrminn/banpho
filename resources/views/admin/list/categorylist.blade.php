                ...
                <caption>
                    <div class="row">
                        ...
                        <div class="col-md-auto ms-auto">
                            <a href="/backend/addcategory/menu/{{ $menuId }}"><button type="button"
                            ...
                            <a href="{{ route('list.category', ['menu' => $menuId, 'cate' => 0]) }}"
                        ...
                        @else
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>{{ Str::limit($item->categories_name, 30) }}</td>
                                    <td>
                                        <a
                                            href="{{ route('category.edit', ['menu' => $menuId, 'id' => $item->categories_id]) }}">
                                        ...
                                        <a
                                            href="{{ route('category.delete', ['menu' => $menuId, 'id' => $item->categories_id]) }}">
